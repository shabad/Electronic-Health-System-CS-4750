...
<head>
    ...
    <title>Check in a Patient</title>
    <!-- Bootstrap Core CSS -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-block">
                              <form class="form-horizontal form-material" action="checkin.php" method = "POST">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-12">
                                        <input type="text" class="form-control" name = "daysstayed">
                                      </div>
                                  </div>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-12">
                                      <input type="text" class="form-control" name = "accompaniedby">
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label class="col-sm-12">Companion Phone</label>
                                      <div class="col-sm-12">
                                        <input type="text" class="form-control" name = "companionphone">
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <div class="col-sm-12">
                                          <button class="btn btn-success" name="checkin">Check in Patient</button>
                                      </div>
                                  ...
                                  if(isset($_POST['checkin'])){
                                    ...
                                    $companionphone = $_POST["companionphone"];

                                    $sql = "INSERT INTO Patient (Name, Phone, Address, DOB, Gender, Blood_Group, Days_Stayed)
                                  VALUES ('$name', '$phone','$address', '$dob', '$gender', '$bloodgroup', '$daysstayed')";
