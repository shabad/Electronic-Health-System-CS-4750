                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-block">
                                <h4 class="card-title">Search by Department Location</h4>
                                ...
                                <form action="doctors.php" method = "POST">
                                    ...
                                    <button class="btn btn-success" name="locationsearch">Search</button>
                                </form>
                                </div>
                                    ...
                                    <table class="table stylish-table">
                                        ...
                                        <tbody>
                                          ...
                                          if(isset($_POST['locationsearch'])){
                                            ...
                                            $results = $mysqli->query("SELECT Doctors.Name, Doctors.Contact, Doctors.Gender FROM Doctors WHERE Doctors.Dept_No IN (SELECT Dept_no FROM Departments WHERE Location = '$location');");

                                          }
                                          else{
                                            $results = $mysqli->query("SELECT * FROM Doctors");
                                          }
                                            ...
                                            echo "<tr>";
                                              ...
                                              echo '<td>';
                                                    echo '<h6> '.$row["Name"].' </h6><small class="text-muted">Doctor</small></td>';
